...
def argparser():
    ...
    arg_mdp.add_argument("--gamma_eval", type=float, default=1.0)
    ...
    arg_me.add_argument(
        ...
        type=float,
        default=1e-6,
        help="Tolerance for detecting near-rank-deficient columns in Householder-QR."
    )
    arg_me.add_argument(
        "--hh_canon_sign",
        action="store_true",
        help="Canonicalize QR signs using sign(diag(R)) for more stable logging/comparison."
    )
